      ...
      <motion.div initial="hidden" animate="visible" variants={{ hidden: {}, visible: { transition: { staggerChildren: 0.1 } } }} className="max-w-6xl">
        ...
        <motion.div variants={fadeUp} className="group bg-white border border-gray-100 shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden max-w-md">
          <div className="relative overflow-hidden" style={{ aspectRatio: "4/3" }}>
            ...
            <span className="absolute top-4 left-4 bg-[#ee7514] text-white text-[10px] font-bold px-3 py-1.5 uppercase tracking-wider" style={{ fontFamily: "'Raleway', sans-serif" }}>Otel & Konaklama</span>
          </div>
          <div className="p-5">
            <div className="w-8 h-0.5 bg-[#ee7514] mb-3 transition-all duration-300 group-hover:w-16" />
