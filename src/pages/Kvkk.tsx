...
export default function Kvkk() {
  return (
    <>
      <Helmet>
        <title>KVKK Aydınlatma Metni | Boğaziçi Grup A.Ş.</title>
        <meta name="description" content="Boğaziçi Grup Enerji ve Gıda Sanayi Ticaret Anonim Şirketi Kişisel Verilerin İşlenmesi Aydınlatma Metni (6698 Sayılı Kanun ve Aydınlatma Yükümlülüğü Uyarınca)." />
      </Helmet>
      <SubPageLayout
        ...
        <motion.div initial="hidden" animate="visible" variants={{ hidden: {}, visible: { transition: { staggerChildren: 0.05 } } }} className="max-w-4xl">
          ...
          <motion.div variants={fadeUp} className="bg-[#f8f8f8] p-6 mb-6">
            <ul className="space-y-2 text-[#555] text-[15px]">
              <li className="flex items-start gap-2"><span className="text-[#6cbe59] mt-2 shrink-0">•</span>Kişisel veri işlenip işlenmediğini öğrenme,</li>
              <li className="flex items-start gap-2"><span className="text-[#6cbe59] mt-2 shrink-0">•</span>Kişisel verileri işlenmişse buna ilişkin bilgi talep etme,</li>
              <li className="flex items-start gap-2"><span className="text-[#6cbe59] mt-2 shrink-0">•</span>Kişisel verilerin işlenme amacını ve bunların amacına uygun kullanılıp kullanılmadığını öğrenme,</li>
              <li className="flex items-start gap-2"><span className="text-[#6cbe59] mt-2 shrink-0">•</span>Yurt içinde veya yurt dışında kişisel verilerin aktarıldığı üçüncü kişileri bilme,</li>
              <li className="flex items-start gap-2"><span className="text-[#6cbe59] mt-2 shrink-0">•</span>Kişisel verilerin eksik veya yanlış işlenmiş olması hâlinde bunların düzeltilmesini isteme ve bu kapsamda yapılan işlemin kişisel verilerin aktarıldığı üçüncü kişilere bildirilmesini isteme,</li>
              <li className="flex items-start gap-2"><span className="text-[#6cbe59] mt-2 shrink-0">•</span>KVKK'nun ve ilgili diğer kanun hükümlerine uygun olarak işlenmiş olmasına rağmen, işlenmesini gerektiren sebeplerin ortadan kalkması hâlinde kişisel verilerin silinmesini veya yok edilmesini isteme ve bu kapsamda yapılan işlemin kişisel verilerin aktarıldığı üçüncü kişilere bildirilmesini isteme,</li>
              <li className="flex items-start gap-2"><span className="text-[#6cbe59] mt-2 shrink-0">•</span>İşlenen verilerin münhasıran otomatik sistemler vasıtasıyla analiz edilmesi suretiyle kişinin kendisi aleyhine bir sonucun ortaya çıkmasına itiraz etme,</li>
              <li className="flex items-start gap-2"><span className="text-[#6cbe59] mt-2 shrink-0">•</span>Kişisel verilerin kanuna aykırı olarak işlenmesi sebebiyle zarara uğraması hâlinde zararın giderilmesini talep etme haklarına sahiptir.</li>
            </ul>
          </motion.div>
          <motion.p variants={fadeUp} className="text-[#555] text-[15px] leading-7 mb-6">
