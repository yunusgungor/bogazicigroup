...
export default function InsanKaynaklari() {
  return (
    <>
      <Helmet>
        <title>İnsan Kaynakları ve Kariyer | Boğaziçi Grup A.Ş.</title>
        <meta name="description" content="Boğaziçi Grup ailesine katılın. Açık pozisyonlar ve kariyer fırsatları için iş başvurusu formunu doldurun." />
      </Helmet>
      <SubPageLayout
