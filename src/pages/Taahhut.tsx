...
const projects = allProjects.filter((p) => p.tag === "Taahhüt");

export default function Taahhut() {
  return (
    <>
      <Helmet>
        <title>İnşaat Taahhüt Hizmetleri | Boğaziçi Grup A.Ş.</title>
        <meta name="description" content="Altyapı, üstyapı, endüstriyel tesisler ve enerji santralleri projelerinde Boğaziçi Grup'un taahhüt gücünü keşfedin." />
      </Helmet>
      <SubPageLayout
        title="TAAHHÜT"
        breadcrumbs={[
      ...
      >
        <motion.div initial="hidden" animate="visible" variants={{ hidden: {}, visible: { transition: { staggerChildren: 0.1 } } }} className="max-w-6xl">
          ...
          <motion.div key="taahhut" initial="hidden" animate="visible" variants={staggerSlow}
