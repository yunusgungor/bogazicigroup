...
export default function KalitePolitikamiz() {
  return (
    <>
      <Helmet>
        <title>Kalite Politikamız | Boğaziçi Grup A.Ş.</title>
        <meta name="description" content="Boğaziçi Grup'un çevre politikası, iş sağlığı ve güvenliği (İSG) politikası ve kalite standartları hakkında bilgi edinin." />
      </Helmet>
      <SubPageLayout
